...
public:
	...
	explicit TextMesh(const std::vector<Vertex> &v, const std::vector<GLuint> &i = {}, const std::vector<Texture2D> &t = {});
...
TextMesh::TextMesh(const std::vector<Vertex> &v, const std::vector<GLuint> &i, const std::vector<Texture2D> &t) :
	vertices(v), indices(i), textures(t)
{
	setupVAO();
}

void TextMesh::draw(Shader shader) const
{
